...
type $StrReplace<
    Needle extends Showable = never,
    With extends Showable = never
> = $Optional<$StrReplace3, [Needle, With]>
...
type StrReplace<
    Needle extends Showable,
    With extends Showable,
    Source extends string
> = Needle extends '' ? Source
    : Source extends `${infer Before}${Needle}${infer After}`
    ? StrReplace<Needle, With, `${Before}${With}${After}`>
    : Source
