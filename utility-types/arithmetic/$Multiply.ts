...
type $Multiply<T extends number = never> = $Optional<$Multiply2, [T]>;

interface $Multiply2 extends Type<[number, number]> {
    type: Multiply<A<this>, B<this>>
}

type Multiply<N extends number, I extends number> =
    And<IsNatural<N>, IsNatural<I>> extends true ? _Multiply<N, I> : number;

type _Multiply<
    N extends number, I extends number, R extends number = 0
> = I extends 0 ? R : _Multiply<N, Prev<I>, Add<N, R>>;
