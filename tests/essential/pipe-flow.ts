...
test('Pipe' as const, t => [
    ...
    t.equal<PipeUnsafe<[1, 2], [$Add, $Next]>, 4>(),
    t.equal<PipeUnsafe<[1], [$Next, $Exclaim]>, "2!">(),
])

// PipeUnsafe does not produce errors with Generics
type Next<T extends number> = PipeUnsafe<[T], [$Next]>;
