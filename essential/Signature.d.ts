...
export declare type Signature<$T extends Type | Type[]> = $T extends Type[] ? MapOver<$T, $VerboseSignature> : $T extends Type ? _Signature<$T> : never;
declare type _Signature<$T extends Type> = {
    input: $T['constraints'];
    output: $T['type'];
};
